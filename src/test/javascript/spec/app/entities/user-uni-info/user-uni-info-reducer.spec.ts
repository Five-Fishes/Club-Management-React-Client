...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [REQUEST(ACTION_TYPES.CREATE_USERUNIINFO), REQUEST(ACTION_TYPES.UPDATE_USERUNIINFO), REQUEST(ACTION_TYPES.DELETE_USERUNIINFO)],
        {},
        state => {
          expect(state).toMatchObject({
            errResponse: null,
  ...
  describe('Failures', () => {
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          FAILURE(ACTION_TYPES.FETCH_USERUNIINFO_LIST),
