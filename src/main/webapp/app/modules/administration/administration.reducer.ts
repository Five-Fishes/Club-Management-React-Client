...
export default (state: IAdministrationState = initialState, action: AnyAction): IAdministrationState => {
  switch (action.type) {
...
export const changeLogLevel = (name: any, configuredLevel: any) => {
...
export const getAudits = (page: any, size: any, sort: any, fromDate: any, toDate: any) => {
