  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="clubmanagementApp.transaction.delete.question">
          <Translate contentKey="clubmanagementApp.transaction.delete.question" interpolate={{ id: transactionEntity.id }}>
